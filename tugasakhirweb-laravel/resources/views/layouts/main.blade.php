  ...
  <nav class="main-header navbar fixed-top navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/home" class="nav-link {{ ($title ==='Tab Home') ? 'active' : '' }}" >Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/mahasiswa" class="nav-link {{ ($title ==='Tab Mahasiswa') ? 'active' : ''}}">Mahasiswa</a>
      </li>
    </ul>
